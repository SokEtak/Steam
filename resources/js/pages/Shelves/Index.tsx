        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 sm:p-6 lg:p-5 xl:p-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {isTableLoading ? (
                        Array.from({ length: table.getState().pagination.pageSize }).map((_, index) => (
                            <Card key={index} className="border-indigo-200 dark:border-indigo-700">
                                <CardHeader>
                        ...
                        table.getRowModel().rows.map((row) => (
                            <TooltipProvider key={row.id}>
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Card
                                            className="hover:bg-indigo-50 dark:hover:bg-indigo-800 transition-colors cursor-pointer border-indigo-200 dark:border-indigo-700"
                                            onClick={() => {
                                                setRowModalOpen(true);
                                                setSelectedRow(row.original);
                                            }}
                                        >
                                            <CardHeader className="flex flex-row items-center justify-between">
                                                <CardTitle className="text-lg font-semibold text-indigo-600 dark:text-indigo-300">
                                                    {row.original.code}
                                                </CardTitle>
                                                {flexRender(
                                            ...
                                            <CardContent className="space-y-2">
                                                <p className="text-sm text-gray-800 dark:text-gray-100">
                                                    <strong className="text-indigo-500 dark:text-indigo-300">ID:</strong> {row.original.id}
                                                </p>
                                                <p className="text-sm text-gray-800 dark:text-gray-100">
                                                    <strong className="text-indigo-500 dark:text-indigo-300">Bookcase:</strong>{" "}
                                                    {row.original.bookcase ? (
                                                        <Link
                                                            href={route("bookcases.show", { id: row.original.bookcase.id })}
                                                            className="text-indigo-600 dark:text-indigo-300 hover:underline"
                                                            onClick={(e) => e.stopPropagation()}
                                                        >
                                                ...
                                                <p className="text-sm text-gray-800 dark:text-gray-100">
                                                    <strong className="text-indigo-500 dark:text-indigo-300">Books Count:</strong>{" "}
                                                    {row.original.books_count || 0}
                                                </p>
                                            </CardContent>
                                        </Card>
                        ...
                        <Card className="col-span-full border-indigo-200 dark:border-indigo-700">
                            <CardContent className="p-6 text-center text-gray-600 dark:text-gray-300 text-sm">
                                No shelves found.
                            </CardContent>
                        </Card>
                    )}
