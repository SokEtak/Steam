                ...
                {isModalOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                type="button"
                                className="absolute top-3 right-3 flex items-center justify-center w-10 h-10 rounded-full bg-gray-200/70 dark:bg-gray-700/70 text-gray-800 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-600 transition-transform duration-200 hover:scale-110"
                                onClick={() => setIsModalOpen(false)}
