// resources/js/Pages/AssetTransactions/Edit.tsx
"use client";
...
interface AssetTransactionsEditProps {
...
export default function AssetTransactionsEdit({
    ...
    const initialFormData = {
        asset_id: assetTransaction.asset.id.toString(),
        type: assetTransaction.type,
        performed_by: assetTransaction.performed_by.toString(),
        performed_at: formatDateForInput(assetTransaction.performed_at),
        from_department_id: assetTransaction.from_department_id?.toString() || "",
        to_department_id: assetTransaction.to_department_id?.toString() || "",
        from_room_id: assetTransaction.from_room_id?.toString() || "",
        to_room_id: assetTransaction.to_room_id?.toString() || "",
    ...
    const selectedNames = useMemo(() => ({
        asset: assets.find(a => a.id.toString() === data.asset_id)?.name || assetTransaction.asset.name,
