                                            ...
                                            {table.getRowModel().rows.map((row) => (
                                                ...
                                                >
                                                    <div className="flex gap-4 items-start">
                                                        <img
                                                            src={row.original.cover || '/images/fallback-cover.jpg'}
                                                            alt="Book cover"
                                    ...
                                    <TabsList className="mb-4 flex w-full flex-wrap justify-center gap-2">
                                        ...
                                        <TabsContent value="classify">
                                            <div className="space-y-2">
                                                ...
                                                <p><strong className="text-blue-600 dark:text-blue-300">កម្រិត:</strong> {rowModal.grade?.name || 'N/A'}</p>
                                                <p><strong className="text-blue-600 dark:text-blue-300">មុខជំនាញ:</strong> {rowModal.subject?.name || 'N/A'}</p>
                                        ...
                                        <TabsContent value="cover">
                                            <div className="flex flex-col items-center gap-2">
                                                {rowModal.cover ? (
                                                    <img src={rowModal.cover} alt="Book cover" className="h-80 w-56 rounded border border-blue-300 object-cover shadow" onError={(e) => (e.currentTarget.src = '/images/fallback-cover.jpg')} />
                                                ) : (
