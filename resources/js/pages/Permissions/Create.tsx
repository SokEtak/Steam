...
export default function PermissionsCreate({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t.createTitle || "Create Permission"} />
                ...
                <div className="max-w-1xl mx-auto">
                    <div className={`${commonStyles.card} p-6 lg:p-8`}>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50 tracking-tight mb-8">
                            {t.createTitle || "Create Permission"}
                        </h1>
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Input
                                                ...
                                                placeholder={t.createNamePlaceholder || "Enter role name"}
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.createNameTooltip || "Enter a unique name for the role"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                {errors.name && (
                            ...
                            <div className="flex justify-end space-x-4 mt-8">
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.createCreateTooltip || "Save the new role"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.createCancelTooltip || "Return to permissions list"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
