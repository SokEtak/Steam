...
export default function PermissionsEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t.editBreadcrumb || "Edit Permission", href: "" },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t.editTitle || "Edit Permission"} />
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Input
                                                ...
                                                placeholder={t.editNamePlaceholder || "Enter role name"}
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.editNameTooltip || "Enter a unique name for the role"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                {errors.name && (
                            ...
                            <div className="flex justify-end space-x-4 mt-8">
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.editUpdateTooltip || "Save changes to the role"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent className="bg-indigo-600 text-white rounded-lg p-2">
                                            {t.editCancelTooltip || "Return to permissions list"}
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
