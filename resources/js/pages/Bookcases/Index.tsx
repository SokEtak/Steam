...
export default function BookcasesIndex({ bookcases, flash }: BookcasesIndexProps) {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {bookcases.length > 0 ? (
                            bookcases.map((bookcase) => (
                                ...
                                >
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Bookcase #{bookcase.id}</h3>
                                    <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Code:</strong> {bookcase.code}</p>
                                    <p className="text-sm text-gray-700 dark:text-gray-300"><strong>Books Count:</strong> {bookcase.books_count ?? 0}</p>
                            ...
                            {bookcases.length > 0 ? (
                                bookcases.map((bookcase) => (
                                    <TableRow key={bookcase.id}>
                                        ...
                                        <TableCell>{bookcase.books_count ?? 0}</TableCell>
