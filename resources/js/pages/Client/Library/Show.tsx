        ...
        return (
            <div className="group flex items-center gap-3 rounded-full p-2 transition-colors hover:bg-gray-100/70 sm:p-3 dark:hover:bg-gray-800/70">
                <img
                    ...
                    alt={book.user.name}
                    className="h-9 w-9 rounded-full border-2 border-amber-500 object-cover shadow-sm sm:h-10 sm:w-10"
                />
                                            ...
                                            <div className="w-full max-w-[160px]">
                                                <div className="aspect-[3/4] w-full overflow-hidden rounded-md">
                                                    <img
                                                        ...
                                                        className="h-full w-full transform object-cover shadow-md transition duration-300 group-hover:scale-[1.03]"
                                                        loading="lazy"
                                                    />
                                                </div>
                                            </div>
