            ...
            <div className="p-4 sm:p-6 lg:p-5 xl:p-2">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-indigo-900 rounded-2xl shadow-2xl border border-indigo-200 dark:border-indigo-700 p-6">
                    ...
                    {showErrorAlert && Object.keys(errors).length > 0 && (
                        <Alert
                            className="mb-4 flex items-start justify-between bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900 dark:to-red-800 text-gray-800 dark:text-gray-100 border border-red-200 dark:border-red-700 rounded-xl"
                        >
                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Input
                                            ...
                                            } focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 transition-all duration-200`}
                                            disabled={processing}
                        ...
                        <div className="space-y-2">
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    ...
                                    <TooltipContent className="bg-gradient-to-br from-blue-900 to-indigo-600 text-white rounded-xl">
                                        Select the loaner who borrowing the book
                                    </TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                            {errors.user_id && (
