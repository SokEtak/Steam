...
// 1. IMPORT CHROME
import { LoaderCircle, AtSign, KeyRound, Eye, EyeOff, CheckCircle2, XCircle, AlertTriangle, Cloud, Chrome } from 'lucide-react';
...
// 2. REMOVED GoogleIconSVG constant
...
export function LoginForm({
    ...
    /**
     * Handles the redirect for Google OAuth login.
     */
    const handleGoogleLogin = () => {
        // Assuming your Google redirect route is named 'auth.google' from your routes file
                ...
                <CardContent className="p-0">
                    <form className="p-8 space-y-7" onSubmit={submit}>
                        ...
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full h-11 transition-all duration-300 border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 font-semibold"
                            onClick={handleGoogleLogin}
                        >
                            {/* 3. USE LUCIDE CHROME ICON */}
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 h-10 border-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-50"
                                    />
                                </div>
                            ...
                            <div className="grid gap-2">
                                <div className="flex items-center">
                                    ...
                                    {canResetPassword && (
                                        <a
                                            ...
                                            className="ml-auto text-sm text-blue-600 dark:text-blue-400 underline-offset-4 hover:underline transition"
                                        >
                                            Forgot password?
                                        </a>
                                    )}
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 pr-10 h-10 border-gray-300 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-50"
                                    />
                                    <Button
                                        type="button"
                                        variant="ghost"
                                        size="sm"
                                        className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 p-0 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                        ...
                        <Button
                            type="submit"
                            className="w-full h-11 text-lg font-semibold bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/50 dark:shadow-blue-900/50"
                            disabled={processing}
                        >
                        ...
                        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <a href={route('register')} className="font-medium text-blue-600 dark:text-blue-400 underline-offset-4 hover:underline transition">
                                Sign up
                            </a>
                        </div>
                    </form>
