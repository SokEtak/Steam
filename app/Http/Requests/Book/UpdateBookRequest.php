...
class UpdateBookRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'pdf_url' => [$isEbook && !$this->route('book')?->pdf_url ? 'required' : 'nullable', 'mimes:pdf', 'max:30720'], // Required only if no existing PDF
            'category_id' => ['required', 'exists:categories,id'],
            'subcategory_id' => ['nullable', 'exists:sub_categories,id'],
            'shelf_id' => [$isEbook ? 'nullable' : 'required', 'exists:shelves,id'],
            'bookcase_id' => [$isEbook ? 'nullable' : 'required', 'exists:bookcases,id'],
